//! Based on fork of three-d with a wireframe struct
//! by https://github.com/nowakf, licensed MIT
//!
//! https://github.com/asny/three-d/pull/552/files#diff-811a6d05bfb0cfb3793def5afeed640899c766186869bf489f47523bff7928b3
//!
//! https://github.com/asny/three-d/blob/a59a6e099459c311ee974c77fc362e5cdaced75a/src/renderer/object/wireframe.rs
...
impl Material for WireframeMaterial {
    fn fragment_shader_source(&self, _lights: &[&dyn Light]) -> String {
        include_str!("./shaders/wireframe.frag").into()
    }

    fn id(&self) -> EffectMaterialId {
        EffectMaterialId(0x1A87)
    }
